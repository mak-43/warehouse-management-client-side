...
const Blogs = () => {
    return (
        <div>
            1*.Diferencence between js and node.js
            ...
            This is an upgraded version of the ECMA script that only uses Chrome's V8 engine written in C ++.while Nodes are written in C, C ++, and JavaScript. <br /> <br />

            2*.when should you use node js and when you use mongodb
            ...
            Different databases have different strengths (the things they are the best) and different ways to use them so choosing the right / best database for what you are doing is entirely up to your decision. <br /> <br />
            ...
            SQL databases are good for multi-row transactions, while NoSQL is good for unstructured data like documents or JSON. <br /> <br />
